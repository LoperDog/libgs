...
#ifndef PROTOBUF_rest_2eproto__INCLUDED
#define PROTOBUF_rest_2eproto__INCLUDED
...
void InitDefaultsRoomlist_RoomlistEntry_DoNotUseImpl();
void InitDefaultsRoomlist_RoomlistEntry_DoNotUse();
void InitDefaultsRoomlistImpl();
void InitDefaultsRoomlist();
void InitDefaultsRoommakeImpl();
void InitDefaultsRoommake();
void InitDefaultsRoominsertImpl();
void InitDefaultsRoominsert();
void InitDefaultsChatmsgImpl();
void InitDefaultsChatmsg();
inline void InitDefaults() {
  InitDefaultsSearchRequest();
  InitDefaultsLogin();
  InitDefaultsRoomlist_RoomlistEntry_DoNotUse();
  InitDefaultsRoomlist();
  InitDefaultsRoommake();
  InitDefaultsRoominsert();
  InitDefaultsChatmsg();
}
}  // namespace protobuf_rest_2eproto
class Chatmsg;
...
class SearchRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SearchRequest) */ {
 ...
 private:
  ...
  friend void ::protobuf_rest_2eproto::InitDefaultsSearchRequestImpl();
};
// -------------------------------------------------------------------
...
class Login : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Login) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_rest_2eproto::TableStruct;
  friend void ::protobuf_rest_2eproto::InitDefaultsLoginImpl();
};
// -------------------------------------------------------------------
...
class Roomlist : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Roomlist) */ {
 public:
  ...
  inline Roomlist* New() const PROTOBUF_FINAL { return New(NULL); }

  Roomlist* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_rest_2eproto::TableStruct;
  friend void ::protobuf_rest_2eproto::InitDefaultsRoomlistImpl();
};
// -------------------------------------------------------------------
...
class Roommake : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Roommake) */ {
 public:
  ...
  inline Roommake* New() const PROTOBUF_FINAL { return New(NULL); }

  Roommake* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_rest_2eproto::TableStruct;
  friend void ::protobuf_rest_2eproto::InitDefaultsRoommakeImpl();
};
// -------------------------------------------------------------------
...
class Roominsert : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Roominsert) */ {
 public:
  ...
  inline Roominsert* New() const PROTOBUF_FINAL { return New(NULL); }

  Roominsert* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_rest_2eproto::TableStruct;
  friend void ::protobuf_rest_2eproto::InitDefaultsRoominsertImpl();
};
// -------------------------------------------------------------------
...
class Chatmsg : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Chatmsg) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_rest_2eproto::TableStruct;
  friend void ::protobuf_rest_2eproto::InitDefaultsChatmsgImpl();
};
// ===================================================================
...
template <> struct is_proto_enum< ::Login_MessageType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Login_MessageType>() {
  return ::Login_MessageType_descriptor();
}
template <> struct is_proto_enum< ::Roommake_MessageType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Roommake_MessageType>() {
  return ::Roommake_MessageType_descriptor();
}
template <> struct is_proto_enum< ::Roominsert_MessageType> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_rest_2eproto__INCLUDED
